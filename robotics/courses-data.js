const coursesData = {
    ...
    "math101": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1M4AeWCGQ74CFMm6mBaxRXuvtPbEJxrTy?usp=sharing" }],
    ...
    "phys103": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1jnUM_wApPWSIBDiTj3yHGXS5259_8Op4?usp=sharing" }],
    ...
    "la140": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1gw4AUsLDq66Mw_YEs3FUdh5fEcPYZOyk?usp=sharing" }],
    ...
    "ai240": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/14wrPo3O45Amb2volcvA_QvZ3CmOsehG-?usp=sharing" }]
        }
    },
    "ds211": {
    ...
    "de203": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1LcmdmHrVzONWgoWP3iBxN0UYrGbnHvYR?usp=sharing" }],
    ...
    "mech215": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1zs6_OeZoo0MRedg8XU97d86Ud0dXG-Tg?usp=sharing" }]
        }
    },
    "elec320": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1xcnnLHgvcoRY6kQUIr-DmyUImOTpag64?usp=sharing" }]
        }
    },
    "ar102": {
        title: "اللغة العربية",
    ...
    "ml249": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1qgGAbZuGW-P9VTT0Jdlw4HzGGjjd7cvE?usp=sharing" }]
        }
    },
    "signals331": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1N--X7OhCdMQwCCPy0jxx4d338SzvSqKx?usp=sharing" }]
        }
    },
    "dynamics350": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/18HygyHneyaA0MGcjV3PFdR8vM-O3d15M?usp=sharing" }]
        }
    },
    "skills103": {
    ...
    "db221": {
        ...
        resources: {
            ...
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1EoRTOIJmCpCBvwLrmw_P6go6sed-QUVT?usp=sharing" }],
    ...
    "dl342": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1tRXVdGDZa9NKiXC3SNDMp1_c9U_goDAl?usp=sharing" }]
        }
    },
    "embedded332": {
        title: "أنظمة التشغيل المدمجة",
        code: "ع ر 332",
        creditHours: "3 ساعات",
        lineNumber: "2043321",
        faculty: "كلية تكنولوجيا الحاسوب والمعلومات",
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1ysWYt2koRyR9phHfkgahYpms8hj8IHnU?usp=sharing" }]
        }
    },
    "cv340": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/15C5wvD2Q1GBkf4cBg9RV0K82hP4oM3Cs?usp=sharing" }]
        }
    },
    "sensors360": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1dD9pdVUQFqvztwotBy7ORVNlDLijM8jV?usp=sharing" }]
        }
    },
    "training391": {
    ...
    "lab310": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/16OBl8NkxAjBJg3hq_PvD4Gr7rThfpTfL?usp=sharing" }]
        }
    },
    "mobile461": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1wcSOCTA1uQdObu1eAZxzVOaX-zyPnAQq?usp=sharing" }]
        }
    },
    "mobilelab462": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/13NQ5wnTjaifsBzccVNDRhQygE_60rPaZ?usp=sharing" }]
        }
    },
    "design463": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1CgnzexFbubrLFc8NARVnU47uJJiZJNrJ?usp=sharing" }]
        }
    },
    "gp1": {
        title: "مشروع تخرج (1)",
    ...
    "industriallab465": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1K7xuAkcpRC9EF-KNw2UD6Rv2qS4MtdjA?usp=sharing" }]
        }
    },
    "gp2": {
        title: "مشروع تخرج (2)",
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1Io7pEWqb1-YgwjLYdpk-UtKSejzeWld-?usp=sharing" }]
        }
    },
    "national110": {
        ...
        resources: {
            files: [{ title: "📁 تصفح المكتبة الدراسية", url: "https://drive.google.com/drive/folders/1AJakMRbotPuAq36ngqrO5msBkuLrs2m7?usp=sharing" }],
